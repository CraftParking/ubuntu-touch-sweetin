...
MouseArea {
    ...
    // separate Yes/No dialogs for reboot/shutdown - used to both fall into the
    // combined multi-button Power dialog below, needs the matching
    // indicator-session fix (END_SESSION_TYPE_SHUTDOWN) to tell them apart
    Component {
        ...
        ShellDialog {
            ...
            Button {
                ...
                text: i18n.tr("Yes")
                onClicked: {
                    dialogLoader.sourceComponent = rebootInProgressComponent;
                }
    ...
    Component {
        ...
        ShellDialog {
            id: shutdownDialog
            title: i18n.ctr("Title: Shut down dialog", "Shut Down")
            ...
            Button {
                ...
                text: i18n.tr("Yes")
                onClicked: {
                    dialogLoader.sourceComponent = shutdownInProgressComponent;
                }
                color: theme.palette.normal.negative
                Component.onCompleted: if (root.hasKeyboard) forceActiveFocus(Qt.TabFocusReason)
            }
    ...
    Component {
        id: rebootInProgressComponent
        ActionInProgressScreen {
            iconSource: "image://theme/system-restart"
            iconFallback: "/usr/share/icons/suru/actions/scalable/system-restart.svg"
            message: i18n.tr("Restarting…")
            subMessage: i18n.tr("Please don't hold the power button.")
            onCountdownFinished: {
    ...
    Component {
        id: shutdownInProgressComponent
        ActionInProgressScreen {
            iconSource: "image://theme/system-shutdown"
            iconFallback: "/usr/share/icons/suru/actions/scalable/system-shutdown.svg"
            message: i18n.tr("Shutting down…")
            subMessage: i18n.tr("Please don't hold the power button.")
            onCountdownFinished: {
                doOnClosedAllWindows = function(root) {
                    return function() {
